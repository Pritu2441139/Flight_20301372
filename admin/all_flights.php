...
if(isset($_POST['del_flight']) and isset($_SESSION['adminId'])) {
  ...
  $sql = 'DELETE FROM One_Way_Flight WHERE flight_id=?';
  ...
  $sql = 'DELETE FROM Round_Trip_Flight WHERE flight_id=?';
  $stmt = mysqli_stmt_init($conn);
  if(!mysqli_stmt_prepare($stmt,$sql)) {
      header('Location: ../index.php?error=sqlerror');
      exit();            
          ...
          <div class="container-md mt-2">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <?php
                $sql = 'SELECT * FROM One_Way_Flight ORDER BY flight_id DESC';
                $stmt = mysqli_stmt_init($conn);
        ...
        if(isset($_SESSION['adminId'])) { ?>
          <div class="container-md mt-2">
            ...
            <table class="table table-bordered">
              ...
              <?php
                $sql = 'SELECT * FROM Round_Trip_Flight ORDER BY flight_id DESC';
                $stmt = mysqli_stmt_init($conn);
                mysqli_stmt_prepare($stmt,$sql);                
                mysqli_stmt_execute($stmt);
                $result = mysqli_stmt_get_result($stmt);
